...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3174.592090852314; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2738.3595898883805; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2732.8279201579894; // x position of the perpendicular encoder (in tick units)
    }
